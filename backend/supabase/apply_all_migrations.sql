...
-- Apply this file in the Supabase SQL Editor if you are not using the Supabase CLI.
-- It combines the migrations in backend/supabase/migrations in the required order.
